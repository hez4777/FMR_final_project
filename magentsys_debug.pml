...
#define DEBUG_PRINT(msg, var) printf("DEBUG: %s = %d\n", msg, var)

inline monitor_state() {
    DEBUG_PRINT("pos1_x", pos1_x);
    DEBUG_PRINT("pos1_y", pos1_y);
    DEBUG_PRINT("pos2_x", pos2_x);
    DEBUG_PRINT("pos2_y", pos2_y);
    DEBUG_PRINT("battery1", battery1);
    DEBUG_PRINT("battery2", battery2);
    printf("DEBUG: status1 = %e, status2 = %e\n", status1, status2);
    printf("DEBUG: SNR = %e\n", SNR);
}
